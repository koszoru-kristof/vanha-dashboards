...
|---|---|---|---|---|---|
| **TRMNL OG** | 7.5″, 800×480, 4 greys | Faux wood (light or dark); also black, white, clear, sage, grey | $139 (+$10 larger battery) | BYOS: polls your server's `/api/display`, free, no licence | **Best overall** |
| **Seeed reTerminal E1001** | 7.5″, 800×480, mono | Plastic | ~$79 | TRMNL firmware, ESPHome or SenseCraft | Cheapest ready-made; put it behind a mat |
| **Seeed XIAO 7.5″ ePaper Panel** + wooden frame | 7.5″, 800×480, mono | Real wood, DIY (e.g. IKEA RÖDALM) | ~$60–130 + frame | TRMNL firmware or ESPHome | **Best real-wood option** |
| **Waveshare ESP32-S3 PhotoPainter** | 7.3″, 800×480, Spectra 6 colour | Solid wood, white mat | ~€80–100 | Custom firmware needed to fetch the PNG | Right size and real wood, but slow flashing colour refresh |
| **paperlesspaper OpenPaper 7** | 7.3″, Spectra 6 colour | Solid ash, white mat | €189 | Cloud API push; community Home Assistant integration | Nicest object, but cloud-dependent and colour refresh |
| Soldered Inkplate 10 | 9.7″, 1200×825, mono/greys | 3D-printed plastic | €179 | Arduino / MicroPython | Wrong size, no wood |
| TRMNL X | 10.3″, 1872×1404, 16 greys | Faux wood and others | $229 (+$10 larger battery) | BYOS | Lovely, but needs a new layout |

---

## 1. TRMNL OG (recommended)
...
- **Finland:** EU orders ship from TRMNL's Berlin warehouse with free
  shipping and no duty fees.
- **BYOS (bring your own server):** the device wakes, calls
  ...
  BYOS needs no licence (a $50 BYOD licence exists only for DIY hardware on
  TRMNL's cloud). Point the device at it via *Advanced → Custom Server*.
...
- Fitted into an IKEA wooden frame with a white mat it reads as a framed
  print. That is the "calm, real wood" look, for an evening's fitting.
- Runs TRMNL firmware or ESPHome.

## 4. Waveshare ESP32-S3 PhotoPainter
...
## 5. paperlesspaper OpenPaper 7

- German maker. Solid ash frame with a white mat, 7.3″ Spectra 6 colour, over 6
  months of battery life. Open hardware, firmware and API. Ships in the EU.
- The site lists 1600×1200 for the 7.3″ model, which is doubtful for that
  panel size. Unverified; check before buying.
- Updates are **pushed** through their cloud API (docs linked below), with a
  community HACS integration for Home Assistant. That breaks the
  "local-first, no vendor cloud" rule in [HARDWARE.md](HARDWARE.md).
- The larger OpenPaper L (13.3″, €339) exists too.

## 6. Rejected and why

- **Soldered Inkplate 10:** 9.7″ 1200×825 needs a new layout, and the enclosure
  is 3D-printed plastic. The Croatian EU maker is a plus.
- **TRMNL X:** 10.3″ 1872×1404 with 16 greys is the best screen here, but at
  4:3 the 5:3 designs would need re-laying out, and it costs $229+.
- **Visionect Place & Play:** a commercial signage product. Pricing is by quote and it
...
TRMNL
- [TRMNL OG shop page](https://shop.trmnl.com/products/trmnl)
- [TRMNL OG spec sheet](https://trmnl.com/products/og/spec-sheet)
- [TRMNL X shop page](https://shop.trmnl.com/products/trmnl-x)
- [TRMNL X spec sheet](https://trmnl.com/products/x/spec-sheet)
- [TRMNL X review, trueNetLab](https://truenetlab.com/en/blog/trmnl-x-e-ink-information-screen-review/)
- [International customs / duty fees (Berlin warehouse)](https://help.trmnl.com/en/articles/10498361-international-customs-duty-fees)
- [BYOS docs](https://docs.trmnl.com/go/diy/byos)
- [BYOD/S docs](https://docs.trmnl.com/go/diy/byod-s)
- [Connect your device to Terminus (BYOS)](https://help.trmnl.com/en/articles/12263392-connect-your-device-to-terminus-byos)
- [byos_sinatra reference server](https://github.com/usetrmnl/byos_sinatra)

Seeed
- [reTerminal E1001](https://www.seeedstudio.com/reTerminal-E1001-p-6534.html)
...
- [Seeed: which e-ink display for your Home Assistant dashboard](https://www.seeedstudio.com/blog/2025/10/27/which-is-your-best-e-ink-display-for-your-home-assistant-dashboard/)
- [Tutorial: Home Assistant ePaper dashboard in an IKEA frame](https://tech-my-mind.com/posts/tutos/photoframe-epaper-dashboard/)

Wood-frame colour panels
- [Waveshare ESP32-S3-PhotoPainter](https://www.waveshare.com/esp32-s3-photopainter.htm)
- [paperlesspaper](https://paperlesspaper.de/en)
- [paperlesspaper OpenPaper L](https://paperlesspaper.de/en/openpaper-l)
- [paperlesspaper API docs](https://docs.paperlesspaper.de/)
- [paperlesspaper on GitHub](https://github.com/paperlesspaper)
- [paperlesspaper Home Assistant integration (community)](https://community.home-assistant.io/t/custom-integration-eink-display-from-paperlesspaper-for-home-assistant-keen-to-test/1000425)

Other
- [Soldered Inkplate 10](https://soldered.com/products/inkplate-10)
- [Inkplate 10 at Welectron (EUR price)](https://www.welectron.com/Soldered-Inkplate-10-97-e-paper-board)
- [Visionect Place & Play 13″](https://www.visionect.com/shop/place-play-13/)
